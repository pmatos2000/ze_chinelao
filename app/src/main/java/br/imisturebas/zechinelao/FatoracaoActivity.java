...
public class FatoracaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fatoracao);
        ...
        for(int i = 0; i < total; i++){
            text = new TextView(FatoracaoActivity.this);
        ...
        btn_mais.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                total++;
                TextView text = new TextView(FatoracaoActivity.this);
                text.setText("Entre com o " + total + "º número:");
                ll.addView(text);
                EditText edit = new EditText(FatoracaoActivity.this);
                edit.setInputType(InputType.TYPE_CLASS_NUMBER);
                edit.setFilters(new InputFilter[]{new InputFilter.LengthFilter(9)});
                ll.addView(edit);
            }
        ...
        btn_menos.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(total == 1) {
                    Toast.makeText(FatoracaoActivity.this, "Precisar de pelo menos 1 número para fazer a fatoração", Toast.LENGTH_SHORT).show();
                }
                else {
        ...
        btn_solucao.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                for(int i = 0; i < total; i++){
                    ...
                    if(num == 0 || num == 1){
                        Toast.makeText(FatoracaoActivity.this, "O " + (i+1) + "º tem que ser diferente de zero ou um", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    u[i] = num;
                }
                Intent intent = new Intent(FatoracaoActivity.this, SolucaoActivity.class);
                if(sp.getSelectedItemId() == 0){
                    intent.putExtra("solução", Fatoracao.fatores_tex(u));
                }
                else{
                    intent.putExtra("solução", Fatoracao.fatoracao_tex(u));
                }
                FatoracaoActivity.this.startActivity(intent);
            }
        });
